...
The processing capacity between the 2 programs has increased by a factor of 30, which is almost exactly what 
...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=0.45\hsize]{CpF-I2/Growth1.eps}
\includegraphics[width=0.45\hsize]{CpF-I2/Growth2.eps}
